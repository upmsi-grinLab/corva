...
function UpdateYear(){
  $.ajax({
  	 type: 'POST',
  	 url: '/corva/cgi-bin/MangroveYear.pl',
   	async: false,
   	data: {
    		"loc_id": 	ManLocId 
   	},
...
function UpdateData(){
  $.ajax({
	type: 'POST',
  	url: '/corva/cgi-bin/MangroveData.pl',
 	 	async: false,
   	data: {
   		"loc_id": ManLocId, 
   		"year": MyYears[Index]
...
function UpdateYearCoralData(){
  $.ajax({
   	type: 'POST',
   	url: '/corva/cgi-bin/CoralDataYear.pl',
   	async: false,
   	data: {
...
function UpdateDataCoralData(){
  $.ajax({
   	type: 'POST',
   	url: '/corva/cgi-bin/CoralDataData.pl',
 	 	async: false,
   	data: {
   		"loc_id": ManLocIdCoralData, 
...
function UpdateYearFishSp(){
  $.ajax({
   	type: 'POST',
   	url: '/corva/cgi-bin/FishSpYear.pl',
   	async: false,
   	data: {
...
function UpdateDataFishSp(){
  $.ajax({
   	type: 'POST',
  	url: '/corva/cgi-bin/FishSpData.pl',
 		async: false,
   	data: {
     		"loc_id": ManLocIdFishSp, 
...
function UpdateYearFishDen(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/FishDenYear.pl',
    async: false,
    data: {
...
function UpdateDataFishDen(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/FishDenData.pl',
    async: false,
    data: {
      "loc_id": ManLocIdFishDen, 
...
function UpdateYearFishBio(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/FishBioYear.pl',
    async: false,
    data: {
...
function UpdateDataFishBio(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/FishBioData.pl',
   	async: false,
    data: {
      "loc_id": ManLocIdFishBio, 
...
function UpdateYearSeagrassCover(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/SeagrassCoverYear.pl',
    async: false,
    data: {
...
function UpdateDataSeagrassCover(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/SeagrassCoverData.pl',
    async: false,
    data: {
      "loc_id": ManLocIdSeagrassCover,
...
function UpdateYearSeagrass(){
    $.ajax({
     	type: 'POST',
     	url: '/corva/cgi-bin/SeagrassYear.pl',
     	async: false,
     	data: {
...
function UpdateDataSeagrass(){
    $.ajax({
     	type: 'POST',
     	url: '/corva/cgi-bin/SeagrassData.pl',
   		async: false,
     	data: {
       		"loc_id": ManLocIdSeagrass, 
...
function UpdateYearDeepCoral(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/DeepCoralYear.pl',
    async: false,
    data: {
...
function UpdateDataDeepCoral(){
  $.ajax({
    type: 'POST',
    url: '/corva/cgi-bin/DeepCoralData.pl',
   	async: false,
    data: {
      "loc_id": ManLocIdDeepCoral, 
