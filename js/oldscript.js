...
function loadFishData(id, data, type, component, _givenLabel){
 ...
 //  	}
   ...
   //    document.getElementById(fishSurveyDate).innerHTML = 'None on Record';
  	// 	document.getElementById(component).innerHTML = '<center><img src="files/err/no_data.png" width="100%" style="margin-top: 15px;"></center>'; 
  	// 	return; 
  	// }
  

  /* Commented out by Dex, not yet sure of effect 14:25 PM, July 9 */
  /* Effect: Produces wrong graph for fish bio (Uses out data of VIP) */
...
function loadSeagrassCoverData(id){
  ...
  //   	if(seagrassCover[i].loc_id == id){
	 //      	chartData[seagrassCover[i].survey_date] = [
		//         {"Category": "Enhalus acoroides", "size": seagrassCover[i].E_acor},
		//         {"Category": "Thalassia hemprichii", "size": seagrassCover[i].T_hem},
		//         {"Category": "Cymodocea serrulata", "size": seagrassCover[i].C_ser},
		//         {"Category": "Cymodocea rotundata", "size": seagrassCover[i].C_rot},
		//         {"Category": "Halodule uninervis", "size": seagrassCover[i].H_uni},
		//         {"Category": "Halodule pinifolia", "size": seagrassCover[i].H_pini},
		//         {"Category": "Halophila minor", "size": seagrassCover[i].H_min},
		//         {"Category": "Halophila decipiens", "size": seagrassCover[i].H_deci},
		//         {"Category": "Halophila ovalis", "size": seagrassCover[i].H_ova},
		//         {"Category": "Halophila spinulosa", "size": seagrassCover[i].H_spi},
		//         {"Category": "Syringodium isoetifolium", "size": seagrassCover[i].H_iso}
	 //      	];
  //     	var chartTitle = "Seagrass Cover Data";
...
//       "yField": "Amarc",
//       "valueField": "Amarb",
//       // "xField": myData[0].Amars,     //x - Stem Density
//       // "yField": myData[0].Amarc,     //y - Canopy Cover change to "Total Height"
//       // "valueField": myData[0].Amarb, //value - Basal Area
//       "maxBulletSize": 100
//     }, 
...
//       "yField": "Arumc",
//       "valueField": "Arumb",
//       // "xField": myData[0].Arums,
//       // "yField": myData[0].Arumc,
//       // "valueField": myData[0].Arumb,
//       "maxBulletSize": 100
//     }, 
...
//       "yField": "Bsexc",
//       "valueField": "Bsexb",
//       // "xField": myData[0].Bsexs,
//       // "yField": myData[0].Bsexc,
//       // "valueField": myData[0].Bsexb,
//       "maxBulletSize": 100
//     }, 
...
//        //"lineColor": "Olive",
//       "balloonText": "<i>Bruguiera gymnorhiza</i><br/>Total Height: <b>[[y]]</b><br/>Stem Density: <b>[[x]]</b><br>Basal Area: <b>[[value]]</b>",
//       "bullet": "circle",
//       "labelText": "[[value]]",
//       "bulletBorderAlpha": 0.2,
//       "bulletAlpha": 0.8,
...
//     {
//       "title": "Exoecaria agallocha",
//        //"lineColor": "Olive",
//       "balloonText": "<i>Exoecaria agallocha</i><br/>Total Height: <b>[[y]]</b><br/>Stem Density: <b>[[x]]</b><br>Basal Area: <b>[[value]]</b>",
//       "bullet": "circle",
//       "labelText": "[[value]]",
//       "bulletBorderAlpha": 0.2,
//       "bulletAlpha": 0.8,
